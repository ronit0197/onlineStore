        ...
        <div className='card'>
            <div className='row p-3'>
                <div className='col-md-4'>
                    <img src={product.image} className='img-fluid rounded-start cart-image mx-auto' alt={product.image} />
                </div>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='mt-5 d-flex justify-content-between align-items-center'>
                            <div className='d-flex'>
                                <button className='btn btn-outline-secondary' onClick={() => handleQuantityChange(product.id, product.quantity - 1)}><Icon.Dash size={20}></Icon.Dash></button>
                                <input type="number" min={1} max={25} value={product.quantity} className='form-control shadow-none mx-2 cart-quantity no-spinner' />
                                <button className='btn btn-outline-secondary' onClick={() => handleQuantityChange(product.id, product.quantity + 1)}><Icon.Plus size={20}></Icon.Plus></button>
                            </div>
